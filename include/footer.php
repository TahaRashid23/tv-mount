        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="footer-main section-content">
                    <p class="color-white">Lorem Ipsum is simply dummy text of the printing and typesetting <br> industry.
                    ...
                    <ul class="footer-info contactInfo d-flex align-items-centermt-4">
                        <li><a href="tel:877-221-7051" class="color-white"><span><i class="fa-solid fa-phone"></i></span>877-221-7051</a>
                        </li>
                        ...
                        <li><a href="javascirpt:void(0)" class="color-white"><span><i class="fa-solid fa-location-dot"></i></span>your
                                location here</a></li>
                    </ul>
                </div>
            </div>
