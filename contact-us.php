    ...
    <div class="swiper-container">
        <div class="slider swiper-wrapper">
            ...
            <div class="swiper-slide">
                <section class="contactUsBanner innerBanner banner-bg slide-inner">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
            ...
            <div class="swiper-slide swiper-services">
                <section class="frequently mar-y slide-inner">
                                    ...
                                    <div id="accordion">
                                        ...
                                        <div class="card">
                                            <div class="card-header collapsed" id="headingTwo" data-toggle="collapse"
                                                ...
                                                2. Do You Provide The Mounting Bracket Or Do I Need To Purchase It
                                                Separately??
                                                <div class="faq__icons"><i class="fa-solid fa-plus"></i></div>
                                                <div class="faq__icons"><i class="fa-solid fa-minus"></i></div>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header collapsed" id="headingFour" data-toggle="collapse"
                                                ...
                                                4. How Do You Ensure The Safety And Security Of My TV During
                                                Installation?
                                                <div class="faq__icons"><i class="fa-solid fa-plus"></i></div>
                                                <div class="faq__icons"><i class="fa-solid fa-minus"></i></div>
                                            </div>
